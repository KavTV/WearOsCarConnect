package com.kav.wearoscarconnect.adapters;
...
public class InformationListAdapter extends RecyclerView.Adapter<InformationListAdapter.RecyclerViewHolder> {

    private ArrayList<StatusListItem> dataSource = new ArrayList<StatusListItem>();
    ...
    public InformationListAdapter(Context context, ArrayList<StatusListItem> dataArgs, AdapterCallback callback){
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, final int position) {
        StatusListItem data_provider = dataSource.get(position);
